...
SPECIES_COMPATIBILITY_THRESHOLD = 0.3
...
# Simulation
REPEAT_SIM = 1
NUM_TIME_STEPS = int(5.0 / (TIME_STEP_IN_MSEC / 1000))
...
# 2D
INPUT_SAMPLES_PER_SIMULATION_2D = 32
MAX_HEALTH_POINTS_2D = INPUT_SAMPLES_PER_SIMULATION_2D * NUM_TIME_STEPS
FLIP_POINT_2D = 4
# 3D
INPUT_SAMPLES_PER_SIMULATION_3D = 64
MAX_HEALTH_POINTS_3D = INPUT_SAMPLES_PER_SIMULATION_3D * NUM_TIME_STEPS
FLIP_POINT_3D = 8
# 4D
INPUT_SAMPLES_PER_SIMULATION_4D = 32
MAX_HEALTH_POINTS_4D = INPUT_SAMPLES_PER_SIMULATION_4D * NUM_TIME_STEPS
FLIP_POINT_4D = 4

# 3I3O
INPUT_SAMPLES_PER_SIMULATION_3I3O = 36
MAX_HEALTH_POINTS_3I3O = INPUT_SAMPLES_PER_SIMULATION_3I3O * NUM_TIME_STEPS
FLIP_POINT_3I3O = 3
...
# Cartpole
MAX_POINTS_CARTPOLE_SIM = 200
CARTPOLE_ENV_DURATION = MAX_POINTS_CARTPOLE_SIM * ACTUATOR_WINDOW

# Cartpole Extended
MAX_POINTS_CARTPOLE_SIM_EXT = 600
CARTPOLE_ENV_DURATION_EXT = MAX_POINTS_CARTPOLE_SIM_EXT * ACTUATOR_WINDOW

# Bipedal walker
MAX_POINTS_WALKER_SIM = 200
WALKER_ENV_DURATION = MAX_POINTS_WALKER_SIM * ACTUATOR_WINDOW